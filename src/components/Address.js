...
export default class Address extends Component {
	...
	updatePart(key, value) {
		if (Object.prototype.hasOwnProperty.call(this.state.value, key) && this.state.value[key] !== value) {
	...
	isDirty() {
		return Object.keys(this.state.value).every(key => this.props.value[key] === this.state.value[key]);
	}
